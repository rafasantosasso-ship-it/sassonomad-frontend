...
export const meta = {
  ...
  pageEyebrow: 'SARDEGNA · GUIAS PRÁTICOS',
  pageTitle: 'Quanto Custa Viver na Sardenha em 2026',
  pageDek: 'Números reais de quem já foi — nada de faixa de preço genérica e otimista de blog.',
  productName: 'Guia Viver no Sul da Sardenha',
  seoTitle: 'Quanto Custa Viver na Sardenha em 2026: Tabela Completa | Sasso Nomad',
  seoDescription: 'Custo de vida real no sul da Sardenha em 2026: de €1.240 a €2.160 por mês. Hospedagem, mercado, transporte e coworking em Cagliari, Costa Rei e entroterra.',
};
