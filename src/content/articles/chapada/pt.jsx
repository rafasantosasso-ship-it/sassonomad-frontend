...
export const meta = {
  tag: 'Bahia, Brasil',
  cardTitle: 'Chapada Diamantina: trilhas, poços e Lençóis',
  ...
  seoTitle: 'Chapada Diamantina: Trilhas, Poços e Lençóis — Um Guia Pra Explorar Sem Pressa | Sasso Nomad',
  seoDescription: 'De vans compartilhadas a hospedagens de moradores locais: como explorar a Chapada Diamantina com calma, sem virar mais um turista de passagem.',
};
  ...
  return (
    <>
      ...
      <div className="sn-guide-cta sn-guide-cta--alt">
        ...
        <Link className="sn-guide-cta__button" to={path('guideChapada')}>
