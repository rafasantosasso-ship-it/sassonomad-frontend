export const meta = {
  tag: 'Irlanda',
  cardTitle: 'Irlanda fora do óbvio: vida de nômade além do centro caótico de Dublin',
  ...
  seoTitle: 'Irlanda Fora do Óbvio: Vida de Nômade Além do Centro Caótico de Dublin | Sasso Nomad',
  seoDescription: 'Dublin é "Silicon Docks" — mas a vida de quem trabalha remoto por lá acontece longe do centro, em vilarejos costeiros a 25 minutos de trem.',
};
